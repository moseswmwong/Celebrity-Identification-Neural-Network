...
- Port to Apple's iPhone using Apple's Neural Engine based tensor environment for inference, or using Google's Tensorflow Lite on top of iPhone's Neural-processor/Microcontroller for inference
