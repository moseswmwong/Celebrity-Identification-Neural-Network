...
- Port to nVidia Jetson TX2 Embedded Linux module, for training and inference, which is more suitable for robots, large scale drones, and self-driving vehicle applications
