...
- Port to nVidia Jetson TX2 Embedded Linux module, for training and inference, which is more suitable for robots, large scale drone, and self-driving vehicle applications
